    ...
    <div class="modal-dialog" role="dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Album Dokumentasi </h5>
        ...
        <div class="modal-body">
            ...
            @method('PUT')
                <div class="mb-4 row">
                    <label for="images" class="col-form-label text-gray-900"><strong> Gambar <span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
                ...
                <div class="mb-4 row">
                    <label for="date" class="col-form-label text-gray-900"><strong> Tanggal <span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
                        <input type="date" class="form-control text-gray-900" name="date" value="{{ $g->date }}" required>
                    </div>
                </div>
                <div class="mb-4 row">
                    <label for="description" class="col-md-3 col-form-label text-gray-900"><strong> Deskripsi <span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
                        <input type="hidden" class="form-control text-gray-900" name="description" id="x{{ $index }}" value="{{ $g->description }}">
                        <trix-editor input="x{{ $index }}" placeholder="deskripsi mengenai dokumentasi"></trix-editor>
                    </div>
                </div>
            </div>
            <!-- footer modal -->
