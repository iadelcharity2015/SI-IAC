        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-body">
                    ...
                    <div class="mb-4 row">
                        <label for="nama" class="col-sm-3 col-form-label text-gray-900"><strong> Nama BPH <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-9">
                            <input type="text" class="form-control text-gray-900" name="nama" value="{{ $bph->nama }}" required>
                        </div>
                    </div>
                    <div class="mb-4 row">
                        <label for="angkatan" class="col-sm-3 col-form-label text-gray-900"><strong>Angkatan<span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-9">
                            <input type="text" class="form-control text-gray-900" name="angkatan" value="{{ $bph->angkatan }}" required>
                        </div>
                    </div>
                    <div class="mb-4 row">
                        <label for="status" class="col-sm-3 col-form-label text-gray-900"><strong>Jabatan<span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-9">
                    ...
                    <div class="mb-4 row">
                        <label for="divisi" class="col-sm-3 col-form-label text-gray-900"><strong>Divisi<span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-9">
