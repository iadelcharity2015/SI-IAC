            ...
            <div class="modal-body">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="name" class="col-form-label text-gray-900"><strong> Nama Anda <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nim_awarde" class=" col-form-label text-gray-900"><strong> NIM <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="study_program" class=" col-form-label text-gray-900"><strong>Program Studi<span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="faculty" class=" col-form-label text-gray-900"><strong>Fakultas<span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="generation" class=" col-form-label text-gray-900"><strong> Angkatan <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="email_academics_awarde" class="col-form-label text-gray-900"><strong> Email Akdemik <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="place_of_birth" class="col-form-label text-gray-900"><strong> Tempat Lahir <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="date_of_birth" class=" col-form-label text-gray-900"><strong> Tanggal Lahir <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="gender" class=" col-form-label text-gray-900"><strong> Jenis Kelamin <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="religion" class=" col-form-label text-gray-900"><strong> Agama <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">     
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="address" class="col-form-label text-gray-900"><strong> Alamat <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="email_awarde" class="col-form-label text-gray-900"><strong> Email Pribadi <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="phone_number_awarde" class=" col-form-label text-gray-900"><strong> No Handphone <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="child_of_awarde" class="col-form-label text-gray-900"><strong> Anak Ke <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="number_of_siblings_awarde" class="col-form-label text-gray-900"><strong> Jumlah Saudara <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="account_type_awarde" class=" col-form-label text-gray-900"><strong>Tipe Akun<span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="account_number_awarde" class="col-form-label text-gray-900"><strong> Nomor Akun <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="name_owner_of_account" class="col-form-label text-gray-900"><strong> Nama Pemilik Akun <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="name_of_father_awarde" class="col-form-label text-gray-900"><strong> Nama Ayah <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="father_occupation_of_awarde" class=" col-form-label text-gray-900"><strong> Pekerjaan Ayah <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="father_income_of_awarde" class="col-form-label text-gray-900"><strong> Pendapatan Ayah <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="father_phone_number_awarde" class="col-form-label text-gray-900"><strong> No HP Ayah <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="name_of_mother_awarde" class="col-form-label text-gray-900"><strong> Nama Ibu <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="mother_occupation_of_awarde" class="col-form-label text-gray-900"><strong> Pekerjaan Ibu <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="mother_income_of_awarde" class="col-form-label text-gray-900"><strong> Pendapatan Ibu <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="mother_phone_number_awarde" class="col-form-label text-gray-900"><strong> No HP Ibu <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="address_of_parents_awarde" class="col-form-label text-gray-900"><strong> Alamat Orang-tua <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="dependents_of_parents_awarde" class="col-form-label text-gray-900"><strong> Jumlah Tanggungan Orang-tua <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
