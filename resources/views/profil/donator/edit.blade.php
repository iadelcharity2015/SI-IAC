            ...
            <div class="modal-body">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="generation" value="{{ $donatur->generation }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="address" value="{{ $donatur->address }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="phone_number" value="{{ $donatur->phone_number }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="email" class="col-form-label text-gray-900"><strong> Email </strong></label>
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="email" value="{{ $donatur->email }}">
                                </div>
                            </div>
                        </div>
                    </div>
