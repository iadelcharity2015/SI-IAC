        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-gray-900" id="exampleModalLabel">Tambah Pengeluaran Dana</h5>
                ...
                <div class="modal-body">
                    <div class="mb-4 row">
                        <label for="pengeluaran" class="col-form-label text-gray-800"><strong> Jenis Pengeluaran <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                    ...
                    <div class="mb-4 row">
                        <label for="total_expenditure" class="col-form-label text-gray-800"><strong> Total Pengeluaran <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                            <input type="text" class="form-control text-gray-900" name="total_expenditure" placeholder="1234567890" required>
                        </div>
                    </div>
                    <div class="mb-4 row">
                        <label for="expenditure_description" class="col-form-label text-gray-800"><strong> Catatan </strong></label>
                        <div class="col-md-12">
                            <input type="hidden" class="form-control text-gray-900" name="expenditure_description" id="x">
                            <trix-editor input="x" class="text-gray-900" placeholder="deskripsi mengenai pengeluaran dana"></trix-editor>
                        </div>
                    </div>
                    <div class="mb-4 row">
                        <label for="expenditure_date" class="col-form-label text-gray-800"><strong> Tanggal Pengeluaran <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                            <input type="date" class="form-control text-gray-900" name="expenditure_date" id="dateInput" required>
                        </div>
                    </div>
                    <div class="mb-4 row">
                        <label for="proof_of_expenditure" class="col-form-label text-gray-800"><strong> Bukti Pengeluaran <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
