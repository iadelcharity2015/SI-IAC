    ...
    <div class="modal-dialog" role="dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Pengeluaran Dana </h5>
        ...
        <div class="modal-body">
            ...
            @method('PUT')
                <div class="mb-4 row">
                    <label for="pengeluaran" class="col-form-label text-gray-900"><strong>Jenis Pengeluaran<span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
                ...
                <div class="mb-4 row">
                    <label for="total_expenditure" class="col-form-label text-gray-900"><strong> Total Pengeluaran <span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
                        <input type="text" class="form-control text-gray-900" name="total_expenditure" value="{{ $pl->total_expenditure }}" required>
                    </div>
                </div>
                <div class="mb-4 row">
                    <label for="expenditure_description" class="col-form-label text-gray-900"><strong> Catatan </strong></label>
                    <div class="col-md-12">
                        ...
                        <trix-editor input="x{{ $index }}" placeholder="deskripsi mengenai pengeluaran dana" class="text-gray-900"></trix-editor>
                    </div>
                </div>
                <div class="mb-4 row">
                    <label for="expenditure_date" class="col-form-label text-gray-900"><strong> Tanggal Pengeluaran <span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
                        <input type="date" class="form-control text-gray-900" name="expenditure_date" value="{{ $pl->expenditure_date }}" required>
                    </div>
                </div>
                <div class="mb-4 row">
                    <label for="proof_of_expenditure" class="col-form-label text-gray-900"><strong> Bukti Pengeluaran <span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
