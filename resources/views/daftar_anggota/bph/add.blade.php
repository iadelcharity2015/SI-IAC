        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-4 row">
                        <label for="nama" class="col-form-label text-gray-800 d-block"><strong> Nama BPH <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                    ...
                    <div class="mb-4 row">
                        <label for="status" class="col-form-label text-gray-800"><strong> Jabatan <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                    ...
                    <div class="mb-4 row">
                        <label for="divisi" class="col-form-label text-gray-800"><strong> Divisi <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
