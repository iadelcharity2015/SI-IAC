            ...
            <div class="modal-header justify-content-center">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="col-form-label text-gray-800 d-block"><strong> Kode Nama Donator <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="name" class="col-form-label text-gray-800 d-block"><strong> Nama Donator <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="col-form-label text-gray-800 d-block"><strong> PIC <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="date_of_joining" class="col-form-label text-gray-800"><strong> Tanggal Bergabung <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="struktur_donator" class="col-form-label text-gray-800"><strong> Struktur Donator <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
