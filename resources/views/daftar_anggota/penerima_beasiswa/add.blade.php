                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="name_awarde" class="col-form-label text-gray-800"><strong> Nama Awardee <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="date" class="form-control text-gray-900" name="date_set_as_awardee" placeholder="tanggal diberikan beasiswa" id="dateInput" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="date" class="form-control text-gray-900" name="end_date_as_awardee" placeholder="tanggal berakhir beasiswa">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
