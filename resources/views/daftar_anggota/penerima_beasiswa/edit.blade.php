            ...
            <div class="modal-header justify-content-center">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="name_awarde" id="name_awarde_label" class="col-form-label text-gray-800"><strong> Nama Awardee <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="name_awarde" id="name_awarde" placeholder="nama lengkap awardee" value="{{ $pb->name_awarde }}" required>
                                </div>
                            </div>
                        </div>                                            
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="nim_awarde" placeholder="nim awardee" value="{{ $pb->nim_awarde }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="generation" placeholder="angkatan" value="{{ $pb->generation }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="date_set_as_awardee" class="col-form-label text-gray-800"><strong> Tanggal Diberikan Beasiswa <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                                    <input type="date" class="form-control text-gray-900" name="date_set_as_awardee" placeholder="tanggal diberikan beasiswa" value="{{ $pb->date_set_as_awardee }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="date" class="form-control text-gray-900" name="end_date_as_awardee" placeholder="tanggal berakhir beasiswa" value="{{ $pb->end_date_as_awardee }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="status" class="col-form-label text-gray-800"><strong> Status Beasiswa <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="email" class="form-control text-gray-900" name="email_academics_awarde" placeholder="email akademik" value="{{ $pb->email_academics_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="total_spp_awarde" class="col-form-label text-gray-800"><strong> Total SPP <span class="required" id="name_awarde_required">*</span></strong></label>
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="total_spp_awarde" placeholder="1234567890" value="{{ $pb->total_spp_awarde }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="place_of_birth" placeholder="tempat lahir" value="{{ $pb->place_of_birth }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="date" class="form-control text-gray-900" name="date_of_birth" placeholder="tanggal lahir" value="{{ $pb->date_of_birth }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="address" placeholder="alamat tempat tinggal" value="{{ $pb->address }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="email_awarde" placeholder="email pribadi" value="{{ $pb->email_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="phone_number_awarde" placeholder="080808080808" value="{{ $pb->phone_number_awarde }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="child_of_awarde" placeholder="anak ke" value="{{ $pb->child_of_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="number_of_siblings_awarde" placeholder="jumlah saudara" value="{{ $pb->number_of_siblings_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="account_number_awarde" placeholder="1234567890" value="{{ $pb->account_number_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="name_owner_of_account" placeholder="nama pemilik akun" value="{{ $pb->name_owner_of_account }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="instagram_awarde" placeholder="akun instagram" value="{{ $pb->instagram_awarde }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="facebook_awarde" placeholder="akun facebook" value="{{ $pb->facebook_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="hobby" placeholder="hobby" value="{{ $pb->hobby }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="name_of_father_awarde" placeholder="nama ayah awardee" value="{{ $pb->name_of_father_awarde }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="father_occupation_of_awarde" placeholder="pekerjaan ayah awardee" value="{{ $pb->father_occupation_of_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="father_income_of_awarde" placeholder="1234567890" value="{{ $pb->father_income_of_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="father_phone_number_awarde" placeholder="1234567890" value="{{ $pb->father_phone_number_awarde }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="name_of_mother_awarde" placeholder="nama ibu awardee" value="{{ $pb->name_of_mother_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="mother_occupation_of_awarde" placeholder="pekerjaan ibu awardee" value="{{ $pb->mother_occupation_of_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="mother_income_of_awarde" placeholder="1234567890" value="{{ $pb->mother_income_of_awarde }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="mother_phone_number_awarde" placeholder="1234567890" value="{{ $pb->mother_phone_number_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control text-gray-900" name="address_of_parents_awarde" placeholder="tempat tinggal orang-tua" value="{{ $pb->address_of_parents_awarde }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <input type="number" class="form-control text-gray-900" name="dependents_of_parents_awarde" placeholder="jumlah tanggungan orang-tua" value="{{ $pb->dependents_of_parents_awarde }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="description" class="col-form-label text-gray-800"><strong> Alasan Menerima Beasiswa </strong></label>
                                <div class="container">
