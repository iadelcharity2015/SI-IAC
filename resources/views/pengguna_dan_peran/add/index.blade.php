        ...
        <div class="modal-content ">
            ...
            <div class="modal-header justify-content-center">
                ...
                <div class="modal-body">
                    <div class="mb-4 row">
                        <label for="name" class="col-sm-3 col-form-label text-gray-900"><strong> Nama Pengguna <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-9">
                            <input type="text" class="form-control text-gray-900" name="name" placeholder="nama pengguna" required>
                        </div>
                    </div>               
                    <div class="mb-4 row">
                        <label for="email" class="col-sm-3 col-form-label text-gray-900"><strong> Email <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-9">
                            <input type="email" class="form-control text-gray-900" name="email" required placeholder="email pengguna" required>
                        </div>
                    </div>
                    <div class="mb-4 row">
                        <label for="password" class="col-sm-3 col-form-label text-gray-900"><strong> Password <span class="required" id="name_awarde_required">*</span></strong></label>
                    ...
                    <div class="mb-4 row">
                        <label for="roles" class="col-sm-3 col-form-label text-gray-900"><strong> Role <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-9">
