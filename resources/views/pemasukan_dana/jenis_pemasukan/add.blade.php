        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-4 row">
                        <label for="name_of_type_income" class="col-form-label text-gray-800"><strong> Jenis Pemasukan <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <trix-editor input="x" class="text-gray-900" placeholder="deskripsi jenis pemasukan"></trix-editor>
                        </div>
                    </div>
                </div>
                <!-- footer modal -->
