    ...
    <div class="modal-dialog" role="dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Pemasukan Dana </h5>
        ...
        <div class="modal-body">
            ...
            @method('PUT')
                <div class="mb-4 row">
                    <label for="pengeluaran" class="col-form-label text-gray-900"><strong>Jenis Pemasukan<span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
                ...
                <div class="mb-4 row">
                    <label for="donor_id" class="col-form-label text-gray-900"><strong>Nama Donator<span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
                ...
                <div class="mb-4 row">
                    <label for="donation_amount" class="col-form-label text-gray-900"><strong> Jumlah Donasi <span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
                        <input type="text" class="form-control text-gray-900" name="donation_amount" value="{{ $dd->donation_amount }}" required>
                    </div>
                </div>
                <div class="mb-4 row">
                    <label for="donation_date" class="col-form-label text-gray-900"><strong> Tanggal Donasi <span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
                        <input type="date" class="form-control text-gray-900" name="donation_date" value="{{ $dd->donation_date }}" required>
                    </div>
                </div>
                <div class="mb-4 row">
                    <label for="type_account" class="col-form-label text-gray-900"><strong> Tipe Akun <span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
                ...
                <div class="mb-4 row">
                    <label for="description" class="col-form-label text-gray-900"><strong> Catatan </strong></label>
                    <div class="col-md-12">
                        <input type="hidden" class="form-control" name="description" id="x{{ $index }}" value="{{ $dd->description }}">
                        <trix-editor input="x{{ $index }}" placeholder="deskripsi jenis pemasukan" class="text-gray-900"></trix-editor>
                    </div>
                </div>
                <!-- HTML code for file input and image preview -->
                <div class="mb-4 row">
                    <label for="bukti_transaksi" class="col-form-label text-gray-900"><strong> Bukti Transaksi <span class="required" id="name_awarde_required">*</span></strong></label>
                    <div class="col-md-12">
