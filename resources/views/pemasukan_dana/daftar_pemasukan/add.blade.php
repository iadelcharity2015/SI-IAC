        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-gray-900" id="exampleModalLabel">Tambah Pemasukan Dana</h5>
                ...
                <div class="modal-body">
                    <div class="mb-4 row">
                        <label for="jenis_pemasukan_id" class="col-form-label text-gray-800"><strong> Jenis Pemasukan <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                    ...
                    <div class="mb-4 row">
                        <label for="donors" class="col-form-label text-gray-800"><strong>Nama Donator <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                    ...
                    <div class="mb-4 row">
                        <label for="donation_amount" class="col-form-label text-gray-800"><strong> Jumlah Donasi <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                            <input type="number" class="form-control text-gray-900" name="donation_amount" placeholder="1234567890" required>
                        </div>
                    </div>
                    <div class="mb-4 row">
                        <label for="donation_date" class="col-form-label text-gray-800"><strong> Tanggal Donasi <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                            <input type="date" class="form-control text-gray-900" name="donation_date" id="dateInput" required>
                        </div>
                    </div>
                    <div class="mb-4 row">
                        <label for="type_account" class="col-form-label text-gray-800"><strong> Tipe Akun <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-md-12">
                            ...
                            <trix-editor input="x" class="text-gray-900" placeholder="deskripsi mengenai pemasukan dana"></trix-editor>
                        </div>
                    </div>
                    <div class="mb-4 row">
                        <label for="bukti_transaksi" class="col-form-label text-gray-800"><strong> Bukti Transaksi <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
