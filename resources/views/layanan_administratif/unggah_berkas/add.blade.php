        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-4 row">
                        <label for="dokumen_id" class="col-form-label text-gray-800"><strong> Judul Dokumen <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
                    ...
                    <div class="mb-4 row">
                        <label for="file_beasiswa" class="col-form-label text-gray-800"><strong> File Dokumen <span class="required" id="name_awarde_required">*</span></strong></label>
                        <div class="col-md-12">
