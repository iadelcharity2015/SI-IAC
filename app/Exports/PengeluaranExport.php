...
class PengeluaranExport implements FromCollection, ShouldAutoSize, WithStyles, WithTitle, WithEvents, WithColumnFormatting
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A' . ($highestRow + 1), 'Total Pengeluaran Dana');
    ...
    public function collection()
    {
        ...
        foreach ($data as $index => $item) {
            $collection->push([
                ...
                'Catatan'                       => strip_tags($item->expenditure_description),
            ]);
        }
    ...
    {
        return 'Daftar Pengeluaran Dana';
    }
}
